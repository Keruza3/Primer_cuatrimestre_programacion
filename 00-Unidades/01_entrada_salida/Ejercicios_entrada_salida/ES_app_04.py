...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        self.txt_nombre.delete(0, 100) #poner la cantidad de letras que quieor borrar
        
        Nombre_obtenido = prompt(None , "ingrese su nombre") 
        
        self.txt_nombre.insert(0, Nombre_obtenido)
